...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template name="get-iso19139.ngmp2g1-title">
    <xsl:call-template name="get-iso19139-title"/>
  </xsl:template>

	<xsl:template name="get-iso19139.ngmp2g1-is-service">
		<xsl:call-template name="get-iso19139-is-service"/>
	</xsl:template>

	<xsl:template name="get-iso19139.ngmp2g1-extents-as-json">
		<xsl:call-template name="get-iso19139-extents-as-json"/>
	</xsl:template>

  <xsl:template name="get-iso19139.ngmp2g1-online-source-config">
