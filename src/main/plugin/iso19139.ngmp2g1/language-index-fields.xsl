...
<xsl:stylesheet version="1.0"
    ...
    <xsl:template match="/">
        ...
        <Documents>
            <xsl:for-each select="/*[name(.)='gmd:MD_Metadata' or name(.)='gmi:MI_Metadata' or @gco:isoType='gmd:MD_Metadata']/gmd:locale/gmd:PT_Locale">
            ...
            -->
            <xsl:if test="/*[name(.)='gmd:MD_Metadata' or name(.)='gmi:MI_Metadata' or @gco:isoType='gmd:MD_Metadata']/gmd:locale/gmd:PT_Locale
                        and count(/*[name(.)='gmd:MD_Metadata' or name(.)='gmi:MI_Metadata' or @gco:isoType='gmd:MD_Metadata']/
    ...
    <xsl:template name="document">
        ...
        <Document locale="{$isoLangId}">
            ...
            <xsl:variable name="title"
                          select="/*[name(.)='gmd:MD_Metadata' or name(.)='gmi:MI_Metadata' or @gco:isoType='gmd:MD_Metadata']
                                    /gmd:identificationInfo//gmd:citation//gmd:title//gmd:LocalisedCharacterString[@locale=$poundLangId]"/>
