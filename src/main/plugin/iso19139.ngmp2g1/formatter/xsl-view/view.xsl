...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
 ...
 <!-- Required for utility-fn.xsl -->
  ...
  <xsl:variable name="metadata"
                select="/root/(gmd:MD_Metadata|gmi:MI_Metadata)"/>
  ...
  <xsl:template mode="getMetadataTitle" match="gmd:MD_Metadata|gmi:MI_Metadata">
  ...
  <xsl:template mode="getMetadataAbstract" match="gmd:MD_Metadata|gmi:MI_Metadata">
  ...
  <xsl:template mode="getTags" match="gmd:MD_Metadata|gmi:MI_Metadata">
  ...
  <xsl:template mode="getMetadataHierarchyLevel" match="gmd:MD_Metadata|gmi:MI_Metadata">
    <xsl:value-of select="gmd:hierarchyLevel/gmd:MD_ScopeCode/@codeListValue"/>
  </xsl:template>

  <xsl:template mode="getMetadataThumbnail" match="gmd:MD_Metadata|gmi:MI_Metadata">
    <xsl:value-of select="gmd:identificationInfo/*/gmd:graphicOverview[1]/gmd:MD_BrowseGraphic/gmd:fileName/gco:CharacterString"/>
  </xsl:template>

  <xsl:template mode="getExtent" match="gmd:MD_Metadata|gmi:MI_Metadata">
  ...
  <xsl:template mode="getOverviews" match="gmd:MD_Metadata|gmi:MI_Metadata">
  ...
  <xsl:template mode="getMetadataHeader" match="gmd:MD_Metadata|gmi:MI_Metadata">
  ...
  <xsl:template mode="getMetadataCitation" match="gmd:MD_Metadata|gmi:MI_Metadata">
