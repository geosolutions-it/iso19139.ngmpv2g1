...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:csw="http://www.opengis.net/cat/csw/2.0.2"
  ...
  <xsl:template match="gmd:MD_Metadata|gmi:MI_Metadata|*[@gco:isoType='gmd:MD_Metadata']">
    ...
    <csw:Record>
      ...
      <xsl:for-each
        ...
        <xsl:variable name="rsi" select="/(gmd:MD_Metadata|gmi:MI_Metadata)/gmd:referenceSystemInfo/gmd:MD_ReferenceSystem/
          gmd:referenceSystemIdentifier/gmd:RS_Identifier|/(gmd:MD_Metadata|gmi:MI_Metadata)/gmd:referenceSystemInfo/
